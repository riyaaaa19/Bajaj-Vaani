...
async def chat(
    query: Optional[str] = Query(default=None, description="Question to ask the AI"),
    files: Optional[List[UploadFile]] = File(deafult=None, description="Optional file(s) to provide context"),
