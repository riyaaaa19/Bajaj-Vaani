...
def answer_question(question: str, context: Optional[str] = None) -> str:
    """
    Ask Gemini for a friendly, human-like answer.
    ...
    # Build prompt for friendly and user-friendly response
    prompt_lines = [
        "You are a friendly and helpful AI assistant.",
        "Explain answers clearly in simple words, as if talking to a human. Use examples if needed.",
    ]
    if context:
